...
- [ ] T010 [P] Implement parseTypeSignature function in src/PatternAgent/Tool.hs to parse gram type signatures (e.g., "(name: Text) --> IO Text")
...
- [ ] T094 [US4] Create sayHelloSpec ToolSpecification in src/PatternAgent/HelloWorld.hs with name "sayHello", description, type signature "(name: Text) --> IO Text"
